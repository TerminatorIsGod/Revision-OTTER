...
public:
	...
	FMOD::Studio::EventInstance* saferoomEvent;
	...
	FMOD::Studio::EventInstance* PlaySoundByName(const std::string& soundName, float vol = 1.0f, glm::vec3 pos = glm::vec3(0.0f), bool lowpass = false, float pitch = 1.0f);
